...
def cart_detail(request, total=0, counter=0, cart_items=None):
    ...
    if request.method == 'POST' and 'pay_button' in request.POST:
        try:
            ...
            # Process the payment (replace this with your payment processing logic)

            # Empty the cart
            cart_items.delete()

            messages.success(request, 'Payment successful. Your cart is now empty.')
            return HttpResponseRedirect(reverse('shop:allProdCat'))
